        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div key={index} className="group text-center">
              <div className="relative h-[350px] rounded-none overflow-hidden mb-6 premium-card">
                <Image
                  src={member.image}
                  alt={member.name}
                  fill
                ...
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="flex gap-4 transform translate-y-4 group-transition-transform duration-300">
                    <div className="w-10 h-10 rounded-none bg-white/20 backdrop-blur-md flex items-center justify-center hover:bg-primary transition-colors cursor-pointer">
