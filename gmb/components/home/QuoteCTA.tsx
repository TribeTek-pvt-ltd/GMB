...
const QuoteCTA = () => {
  return (
    <section className="py-24 md:py-32 bg-white border-t border-slate-100">
      <Container>
        <div className="bg-white rounded-[3rem] overflow-hidden relative shadow-[0_20px_60px_-15px_rgba(23,86,160,0.08)] border border-slate-100">
          ...
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-linear-to-r from-transparent via-[#3d9e41]/50 to-transparent" />
          ...
          <div className="px-10 py-20 md:py-24 text-center max-w-2xl mx-auto">
            ...
            <motion.h2
              ...
              className="font-display font-medium text-[#1a2647] text-4xl sm:text-5xl md:text-[3.5rem] leading-[1.1] tracking-tight mb-5"
            >
            ...
            <motion.p
              ...
              className="text-[#1a2647]/55 text-base md:text-lg font-light leading-relaxed mb-11"
            >
            ...
            >
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-white hover:bg-slate-50 border border-slate-200 hover:border-[#3d9e41]/30 text-[#1a2647] hover:text-[#1a2647] px-10 py-4 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] shadow-sm transition-all duration-300"
              >
            ...
            >
              {['Takes 2 minutes', 'Always free', 'Zero pressure'].map((t, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] text-slate-500 font-bold uppercase tracking-[0.18em]">{t}</span>
                </div>
              ))}
            </motion.div>
