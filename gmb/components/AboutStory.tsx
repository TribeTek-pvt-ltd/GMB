        ...
        <div className="relative">
          ...
          <div className="flex justify-between items-center mb-4 relative max-w-3xl mx-auto overflow-x-auto px-2 py-6 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-none flex items-center justify-center border-4 transition-all duration-300 ${index <= activeIndex
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-none shadow-2xl overflow-hidden border border-slate-100 flex flex-col md:flex-row min-h-[380px]">
              {/* Image Section */}
                  ...
                  >
                    ...
                    <div className="mt-6 flex gap-4">
                      <button
                        ...
                        className="p-3 rounded-none border border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-all disabled:opacity-30 disabled:hover:border-slate-200 disabled:hover:text-slate-400"
                      >
                      ...
                      <button
                        ...
                        onClick={() => setActiveIndex(prev => prev + 1)}
                        className="p-3 rounded-none bg-primary text-white shadow-lg shadow-primary/20 transition-all disabled:opacity-30 disabled:scale-100"
                      >
