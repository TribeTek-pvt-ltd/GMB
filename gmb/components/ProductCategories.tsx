    ...
    <section className="py-16 bg-transparent" id="categories">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] bg-gradient-to-r from-[#0F172A] via-[#1F2E5A] to-[#0a1628] sm:col-span-2 lg:col-span-3 group hover:shadow-[0_20px_40px_-15px_rgba(31,46,90,0.5)] transition-all duration-500 border border-white/10 shadow-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between text-center md:text-left p-10 sm:p-12 lg:p-16 gap-8">
              ...
              <Link href="/products" className="shrink-0">
                <button className="relative overflow-hidden bg-white text-slate-900 px-10 py-5 rounded-full font-extrabold tracking-wide text-sm sm:text-base transition-all duration-300 shadow-[0_0_40px_-10px_rgba(255,255,255,0.4)] flex items-center gap-3 group-hover:pr-8 group/btn">
                  Explore Catalog
