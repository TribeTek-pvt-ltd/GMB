...
const QuoteCTA = () => {
  return (
    <section className="w-full relative overflow-hidden bg-gradient-to-r from-[#0F172A] via-[#1F2E5A] to-[#0a1628] py-16 sm:py-24 text-center text-white border-y border-slate-800 mb-12 md:mb-20">
      {/* Decorative elements */}
      ...
      <div className="container max-w-7xl mx-auto relative z-10 px-6 sm:px-8">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            <Link href="/contact">
              <button className="bg-[var(--accent-yellow)] text-white px-6 py-3 rounded-xl font-bold text-lg shadow-xl shadow-amber-500/20 transition-transform w-full sm:w-auto hover:brightness-110 active:scale-95">
                Request Free Quote
              </button>
            </Link>
            <Link href="https://wa.me/917397223388" target="_blank" rel="noopener noreferrer">
              <button className="bg-[#25D366] text-white px-6 py-3 rounded-xl font-bold text-lg transition-transform w-full sm:w-auto flex items-center justify-center gap-2 shadow-xl shadow-green-500/20 hover:brightness-110 active:scale-95">
